...
const index = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>LinkedIn Post Pack - 30 Day Challenge</title><style>${css} .grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(320px,1fr));gap:14px}</style></head><body><div class="wrap"><section class="card" style="margin-bottom:14px"><h1>LinkedIn Content Pack - 30 Day Insurance AI Challenge</h1><p class="body">Total posts: ${cards.length}. Includes architecture/business/nerdy posts, roadmap posts, Day 1-19 app posts, section start/wrap posts, and milestone retrospectives.</p><div class="media-grid"><img class="media" src="assets/diagrams/purpose-hero.png" alt="purpose"><img class="media" src="assets/diagrams/architecture-business.png" alt="arch"><img class="media" src="assets/diagrams/roadmap-buckets.png" alt="roadmap"></div><p class="disclaimer">Disclaimer: Product names, logos, and trademarks are the property of their respective owners and are used for editorial/demo context.</p></section><div class="grid">${cards.join('\n')}</div></div></body></html>`;
