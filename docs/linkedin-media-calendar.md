# LinkedIn Media Calendar (Updated after Day 30 Build)

## Publishing assumptions
- Time zone: UK (`Europe/London`)
- Primary slot: `08:30`
- Secondary slot for section/milestone posts: `17:30`
- Cadence: one primary post per weekday, optional secondary post on Tuesdays/Thursdays
- Goal: complete Day 20-30 app narrative while reinforcing section wrap and challenge-close story

## Content sequencing status
- Foundation and Day 0-19 post artefacts already generated in `content/posts/`
...
## Artefact locations
- Master browser: `content/index.html`
- Canonical metadata: `content/posts.json`
- Per-post files: `content/posts/*.html` and `content/posts/*.md`
- Screenshots: `content/assets/screenshots/day1.png` ... `day30.png`
- App logos: `content/assets/app-logos/day1.svg` ... `day30.svg`

## Pre-publish checklist
- Verify live app URL responds (`HTTP 200`)
- Check screenshot reflects current UI
- Confirm UK English spelling in final caption
- Validate hashtags <= 5 per post
- Keep first two lines concise and curiosity-led
